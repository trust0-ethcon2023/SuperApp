var module = (function() {
    ...
    return {
        ...
        get_transaction_count: function(params) {
            ...
            klaytn.api.get_transaction_count(account, block)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        get_transaction_receipt: function(params) {
            ...
            klaytn.api.get_transaction_receipt(tx_hash)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        send_raw_transaction: function(params) {
            ...
            klaytn.api.send_raw_transaction(transaction)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        request: function(params) {
            ...
            klaytn.api.request(method, JSON.parse(rpc_params || "{}"))
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
