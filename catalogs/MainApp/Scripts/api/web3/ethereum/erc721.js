var module = (function() {
    ...
    return {
        balance_of: function(params) {
            ...
            ethereum.erc721.balance_of(token, owner)
        ...
        owner_of: function(params) {
            ...
            ethereum.erc721.owner_of(token, token_id)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        safe_transfer_from: function(params) {
            ...
            ethereum.erc721.safe_transfer_from(from, token, to, amount)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        transfer_from: function(params) {
            ...
            ethereum.erc721.transfer_from(from, token, to, amount)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        approve: function(params) {
            ...
            ethereum.erc721.approve(from, token, to, token_id)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        get_approved: function(params) {
            ...
            ethereum.erc721.get_approved(token, token_id)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        set_approval_for_all: function(params) {
            ...
            ethereum.erc721.set_approval_for_all(from, token, operator, approved)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        is_approved_for_all: function(params) {
            ...
            ethereum.erc721.is_approved_for_all(token, owner, operator)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        token_uri: function(params) {
            ...
            ethereum.erc721.token_uri(token, token_id)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        total_supply: function(params) {
            ...
            ethereum.erc721.total_supply(token)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        token_of_owner_by_index: function(params) {
            ...
            ethereum.erc721.token_of_owner_by_index(token, owner, index)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
        ...
        token_by_index: function(params) {
            ...
            ethereum.erc721.token_by_index(token, index)
                .then(function(result) {
                    _resolve(params, result);
                })
                .catch(function(error) {
